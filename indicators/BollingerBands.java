...
/*********************************************************************
* Bollinger Bands - Developed by Dr. John Bollinger
*
*********************************************************************/
...
public final class BollingerBands
	...
	{
	public static final String STUDY_NAME="Bollinger Bands";
	public String getName() { return STUDY_NAME; }

	private static final int DEFAULT_PERIOD = 20;
	private static final int DEFAULT_SIGMAS = 2; // multiplier for band widths
	...
	private Color[]       m_color = { Color.PINK, new Color(153,153,153),
	                                  new Color(153,255,255, 100) };
	private int           m_period = DEFAULT_PERIOD;
	private int           m_numSigmas = DEFAULT_SIGMAS;
/**********
Period: 20, int
Price: C, OHLC select
Sigmas: 2, float 2
...
**********/
	...
	public BollingerBands( BarList bars )
		{
		this ( bars, "" );
		}
	public BollingerBands( BarList bars, String params )
		{
		m_bars = bars;
	...
	public void setParams( String params )
		{
System.out.println( getClass().getSimpleName() + ".params: " + m_period + "," + m_numSigmas);
		m_ma = new SMA( m_bars, "20,C" );
		dataChanged(0);
	...
	private void compute(int index)
		...
		m_bandOffset[m_index] = m_numSigmas * (int)Math.sqrt((double)sum / count );
