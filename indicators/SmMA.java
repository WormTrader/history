...
*
* SmMA: Extends MovingAverage to produce the Smoothed Moving Average
*
...
public final class SmMA
	extends MovingAverage
	{
	public static final String STUDY_NAME="SmMA";

	private int[] m_runningSum;

	public SmMA( BarList bars, String params )
		{
		super( bars );
	...
	private void compute(int index)
		...
		if ( index == 0 ) // prime the pump
			...
			if ( index >= m_period )
				{
				int drop = m_runningSum[index-1]/m_period; // drop the perv smoothed avg
