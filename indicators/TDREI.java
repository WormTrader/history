...
/********************************************************************
* @(#)TDREI.java 1.00 2007
* Copyright © 2007-2013 by Richard T. Salamone, Jr. All rights reserved.
*
* TDREI - Range Expansion Index - Developed by Thomas R. DeMark & Jr.
*
...
final public class TDREI
	implements TapeStudy, GraphClipRenderer
	{
	public static final String STUDY_NAME="TDREI";
	...
	private int[]       m_rei; // actual TDREI for each bar; length >= m_bars.size()
	...
	public TDREI( BarList bars )
		{
		this( bars, "" );
		}
	public TDREI( BarList bars, String params )
		{
		m_bars = bars;
	...
	public String getRangeString(int value)
		{
		return "TDREI(" + m_period + "): " + value;
		}
	public String getClipLabel() { return "TDREI(" + m_period + ")"; }
	...
	private void compute(int index)
		...
		if ( ++m_index != index ) // not in order !
			SBDialog.fatalError("TDREI.compute(" + index + ") expected index " + m_index );
